    ...
    public partial class App : Application
    {
        ...
        void RegisterTypes(Injection injection)
        {
            ...
            injection
                ...
                .RegisterSingleton(i => new ItemsViewModel(i.Get<IGroupsClient>()))
                .RegisterSingleton(i => new ItemsPage(i.Get<ItemsViewModel>()))
                .RegisterSingleton(i => new MainPage(i.Get<MainViewModel>(), () => i.Get<ItemsPage>()))
